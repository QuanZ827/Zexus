...
:: Run WiX build
wix build "%WIX_SRC%" -o "%~dp0Output\Zexus_Setup_v0.3.0.1.msi" -arch x64
if errorlevel 1 (
    echo.
...
echo.
echo Verifying MSI...
if exist "%~dp0Output\Zexus_Setup_v0.3.0.1.msi" (
    echo.
    echo ==========================================
    echo   SUCCESS!
    echo.
    echo   MSI Installer: Installer\Output\Zexus_Setup_v0.3.0.1.msi
    echo.
